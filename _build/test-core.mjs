...
equal(chinese[0].fixed_expressions.length, 7, 'registered Chinese passage keeps fixed expressions and paired connectors');
equal(chinese[0].fixed_expressions.find(item => item.kind === 'paired')?.term, '虽然……但……', 'registered Chinese passage keeps the split paired connector');
